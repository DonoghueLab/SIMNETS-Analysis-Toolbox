...
1. Download the tool box from Github or contact authors. 
...
3. For SIMNETS (the dimensionality-reduced Neuron Similarity Map): see **demo/SIMNETS_Live_tutorial.mlx'** for detailed guide on running the SIMNETS function and an explanation of all the sub-functions used in the algoirithm. 

4. For SSIMS (the dimensionality-reduced Ensemble Activity Spiketrain Simliarty Maps: see **demo/SSIMS_democenter_out.m*

5. For more details on the methods, see publications [2] and [3]. 
