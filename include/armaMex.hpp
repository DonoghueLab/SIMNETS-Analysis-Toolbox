/**
 * @file armaMex.hpp
 * @author  George Yammine, Conrad Sanderson
 * @version 0.5
 * @brief Connector for Mex files to use Armadillo for calculation.
 *
 * @section LICENSE
 ...
 * @section DESCRIPTION
 *
 * Collection of functions to facilitate the use of Armadillo in MATLAB Mex files.
 */
#include <armadillo>
#include <mex.h>
#include <mat.h>
