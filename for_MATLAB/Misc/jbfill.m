...
% grid on 
% legend('Datr') 
if nargin<8;transparency=.3;end %default is to have a transparency of .5 
if nargin<7;add=1;end %default is to add to current plot 
if nargin<6;edge='w';end %dfault edge color is white
if nargin<5;color=[ .8 .8 .8];end %default color is blue 
