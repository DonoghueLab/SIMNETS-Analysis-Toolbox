function [ ncmat, dmatnb, basespiketrains] = SSIMSNeuronRelCorr_par(sorted_timestamps, ev, stduration, q, varargin)
...
%% Step 1:Calculate correlation between relational mapping vectors (neurons)
...
for n1 = 1:nn
     ...
     A = getSSIMDMatBetweenTimePoints(spiketrains(n), [events], 1, 10);
    ...
    for n2 = 1:n1
       ...
       B = getSSIMDMatBetweenTimePoints(spiketrains(n), [events], 1, 10);
